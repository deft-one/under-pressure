...
<head>
    ...
    <title>Under Pressure - Exterior Cleaning & Restoration Services</title>
    <meta name="description" content="Our professional technicians provide exterior cleaning services to Spring Hill and surrounding areas including Hernando county, Citrus county, and Pasco county.">
    <meta property="author" content="Carib Glasco | deftoriginals.com">
    <meta property="og:site_name" content="Under Pressure - Exterior Cleaning & Restoration Services"/>
    <!-- DEFTORIGINALS.COM Appears on FB in this order -->
    <meta property="og:title" content="Under Pressure - Exterior Cleaning & Restoration Services" /><!-- Appears on FB in this order -->
    <meta property="og:description" content="Our professional technicians provide exterior cleaning services to Spring Hill and surrounding areas including Hernando county, Citrus county, and Pasco county."><!-- Appears on FB in this order -->
    <meta property="og:image" content="https://deft-one.github.io/under-pressure/images/under-pressure-og.jpg" /><!-- Appears on FB in this order -->
    <meta property="og:image:width" content="1200" />
    <meta property="og:image:height" content="628" />
    <meta property="og:type" content="website" />
    <meta property="og:url" content="https://www.underpressureexteriorcleaning.com/" />
...
<body>
    ...
    <div class="page-contain">
        ...
        <div id="headerContain" class="header-contain">
            <nav>
                <ul id="navUl" class="nav-ul">
                    ...
                    <li class="sub-menu" id="subMenuItem3"><a href="#ourWork" class="sub-menu-a">Our Work</a></li>
                </ul>
            </nav>
        </div>
        <div class="page-sect hero-contain hero-twins">
            <div id="hero" class="hero-text-contain hero-twins">
                <h1 class="hero-h1">Under Pressure</h1>
                <h2 class="hero-h2">Exterior Cleaning and Restoration Services</h2>
                <p class="hero-p">Our professional technicians provide exterior cleaning services to Spring Hill and surrounding areas including Hernando county, Citrus county, and Pasco county.</p>
                <button id="quoteBtn1" class="quote-btn">Free Quote</button>
            </div>
        </div>
        <div class="page-sect">
            <p class="slogan">"Quality first, satisfaction always!"</p>
        </div>
        <div class="page-sect">
            <p class="paragraph question"><strong>Would you like to raise the value of your home by ten percent?</strong></p>
            <p class="paragraph">Our company offers several exterior services that will not only boost your curb appeal, but could also help raise the resale value of your home. &nbsp;When it comes to home maintenance, it’s important to maintain a clean property for aesthetic value and curb appeal. &nbsp;When mold, mildew, algae and other airborne contaminants are allowed to remain on the exterior surfaces of a property, they can cause premature wear on your siding, roof, concrete and gutters. &nbsp;Working with a professional Exterior Cleaning Company can increase the longevity of such surfaces and boost the property’s resale value.</p>
            <p class="paragraph">If you choose to use Under Pressure Exterior Cleaning & Restoration, we take quality seriously and you will always get the best with our exterior cleaning solutions. &nbsp;We look forward to serving  our community in the Hernando, Citrus, and Pasco areas!</p>
            <button id="quoteBtn2" class="quote-btn">Free Quote</button>
        </div>
        <div id="services" class="page-sect">
            <h2 class="services-h2">Exterior Cleaning Services</h2>
            <p class="paragraph">When it comes to the inside of your home, you usually stick to a pretty regular cleaning schedule, or at least you try to. &nbsp;But, it is so easy to forget that the outside of your home needs attention as well! &nbsp;After a long full year of several different seasonal changes, all sorts of dirt, grime, mold, mildew and other airborne contaminants collect on your siding, windows, walkways, patios, roofs,etc. &nbsp;That’s where Under Pressure Exterior Cleaning & Restoration can help. &nbsp;We specialize in residential and commercial exterior cleaning. &nbsp;Whether it is exterior house cleaning, roof cleaning, concrete cleaning, or gutter whitening we have the exterior cleaning experience necessary to get the job done. &nbsp;Our goal is to make your property the beacon of curb appeal which will last for years to come.</p>
            <div class="service-menu-h2">Jump to a Section</div>
            <ul class="services-menu-grid" id="servicesMenu">
                <li class="service-menu-item"><a href="#houses">Houses</a></li>
                <li class="service-menu-item"><a href="#surfaces">Surfaces</a></li>
                <li class="service-menu-item"><a href="#roofs">Roofs</a></li>
                <li class="service-menu-item"><a href="#gutters">Gutters</a></li>
                <li class="service-menu-item"><a href="#fences">Fences</a></li>
                <li class="service-menu-item"><a href="#patios">Patios</a></li>
                <li class="service-menu-item"><a href="#screens">Screens</a></li>
                <li class="service-menu-item"><a href="#windows">Windows</a></li>
                <li class="service-menu-item"><a href="#pavers">Pavers</a></li>
            </ul>
        </div>
        <div class="page-sect services-grid">
        ...
        <div class="page-sect">
            <h2 class="services-h2">What is Soft Washing?</h2>
            <p class="paragraph">Soft washing is a smarter and safer alternative to conventional pressure/power washing. &nbsp;Our cleansing formula established by Under Pressure Exterior Cleaning & Restoration uses water-based, eco-friendly chemicals to break down dirt and grime while also removing pest nests and webs. &nbsp;In addition, this method of exterior cleaning kills mold, mildew and algae as well as bacteria on your roofing system and other surfaces, leaving them clean and sanitized.</p>
            <p class="paragraph">Soft washing eliminates microorganisms that trigger tarnishing while power/pressure washing simply cleans off the surface layer. &nbsp;Furthermore, unlike pressure/power washing, soft washing solutions are applied at pressures not much more than a standard garden hose, greatly reducing any chances of damage caused by pressure.</p>
            <p class="paragraph">If you're looking for a way to get rid of what’s growing on the surfaces around your home or business, break the cycle of constant pressure/power washing and make use of a cleaning option that treats the issues like a pest and not a stain. &nbsp;Then soft washing is just what you have been looking for.</p>
        </div>
        <div id="benefits" class="page-sect">
            <h3 class="service-h3">Benefits of Soft Washing</h3>
            <ul class="benefits-ul">
                <li class="benefits-li"><span class="benefits-span">&#9989; &nbsp;Eco-Friendly</span><span>Biodegradable and uses less water.</span></li>
                <li class="benefits-li"><span class="benefits-span">&#9989; &nbsp;Long Lasting</span><span>Lasts 4 - 6 times longer than pressure washing.</span></li>
                <li class="benefits-li"><span class="benefits-span">&#9989; &nbsp;Over 100,000</span><span>roofs and structures cleaned with soft wash.</span></li>
                <li class="benefits-li"><span class="benefits-span">&#9989; &nbsp;Amazing Results</span><span>Treats the infestations causing stains.</span></li>
                <li class="benefits-li"><span class="benefits-span">&#9989; &nbsp;No Pressure Damage</span><span>No harmful, high- impact cleaning.</span></li>
            </ul>
        </div>
        ...
        <div id="contactModal" class="contact-modal">
            ...
            <div class="close" id="closeForm">CLOSE</div>
        </div>
